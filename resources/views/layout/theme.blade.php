...
<head>
    <meta charset="utf-8">
    <title>Beranda - Berita Garuda</title>
                ...
                <div class="col-lg-8">
                    <div class="owl-carousel owl-carousel-2 carousel-item-1 position-relative mb-3 mb-lg-0">
                        <div class="position-relative overflow-hidden" style="height: 435px;">
                            ...
                            <div class="overlay">
                                <div class="mb-1">
                                    <a class="text-white" href="">Teknologi</a>
                                    <span class="px-2 text-white">/</span>
                                    <a class="text-white" href="">Januari 1, 2050</a>
                                </div>
                                <a class="h2 m-0 text-white font-weight-bold" href="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, corrupti.</a>
                            </div>
                        </div>
                        <div class="position-relative overflow-hidden" style="height: 435px;">
                            ...
                            <div class="overlay">
                                <div class="mb-1">
                                    <a class="text-white" href="">Teknologi</a>
                                    <span class="px-2 text-white">/</span>
                                    <a class="text-white" href="">January 1, 2050</a>
                                </div>
                                <a class="h2 m-0 text-white font-weight-bold" href="">Lorem ipsum dolor sit amet consectetur adipisicing elit. At, maiores?</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="position-relative mb-3">
                                ...
                                <div class="overlay position-relative bg-light">
                                    <div class="mb-2" style="font-size: 14px;">
                                        ...
                                        <span>Januari 01, 2045</span>
                                    </div>
                                    <a class="h4" href="">Lorem ipsum dolor sit amet consectetur adipisicing elit.</a>
                                    <p class="m-0">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vero omnis hic quos obcaecati ipsam illum...</p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                ...
                                <div class="overlay position-relative bg-light">
                                    ...
                                    <a class="h4" href="">Lorem ipsum dolor sit amet consectetur adipisicing elit.</a>
                                    <p class="m-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque aperiam numquam reprehenderit amet...</p>
                                </div>
                            </div>
                            <div class="d-flex mb-3">
